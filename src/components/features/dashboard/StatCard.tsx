...
export function StatCard({
  ...
  const colorVariants = {
    ...
    emerald: {
      ...
      valueGradient:
        'bg-linear-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent',
    ...
    red: {
      ...
      valueGradient:
        'bg-linear-to-r from-red-400 to-pink-400 bg-clip-text text-transparent',
    ...
    orange: {
      ...
      valueGradient:
        'bg-linear-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent',
    ...
    yellow: {
      ...
      valueGradient:
        'bg-linear-to-r from-amber-400 to-yellow-400 bg-clip-text text-transparent',
  ...
  return (
    ...
    >
      <div
        className={`relative h-full border bg-linear-to-br from-gray-900/95 to-gray-950/95 p-6 backdrop-blur-xl ${variant.border} ${variant.hoverBorder}transition-all duration-300 ease-out before:absolute before:inset-0 before:bg-linear-to-br hover:shadow-2xl hover:shadow-black/20 before:${variant.gradient}before:pointer-events-none overflow-hidden rounded-[8px] before:rounded-[8px]`}
      >
        ...
        <div className="pointer-events-none absolute inset-0 rounded-[8px] bg-linear-to-br from-white/5 to-transparent" />
        ...
        >
          ...
          <div className="h-1 w-full overflow-hidden rounded-full bg-gray-800/50">
            <motion.div
              className={`h-full bg-linear-to-r ${variant.progressGradient}`}
              initial={{ width: 0 }}
              animate={{ width: '75%' }}
