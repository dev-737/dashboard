  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      <div className="relative">
        <div
          className={`premium-card flex h-12 w-full items-center overflow-hidden rounded-(--radius-button) border bg-gray-900/50 px-3 shadow-lg backdrop-blur-sm transition-all duration-300 sm:h-14 sm:px-4 ${
            isFocused
