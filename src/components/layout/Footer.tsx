...
export function Footer() {
    const footerLinks = {
        legal: [
            ...
            { label: 'Premium Billing Terms', href: '/premium/terms', icon: File01Icon },
    ...
    return (
        <footer
            className={`border-t border-dash-border/50 bg-dash-surface ${pathname === '/discover' ? 'hidden' : ''}`}
        >
            <div className="container mx-auto px-4 py-12">
                            ...
                            {footerLinks.social.map((link) => (
                                <div key={link.href}>
                                    <Link
                                        ...
                                        className="group"
                                    >
                                        <div className="flex items-center gap-3 rounded-lg border border-dash-border/50 bg-dash-main p-3 transition-all duration-200 hover:border-gray-600/50 hover:bg-gray-800/50">
                                            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-800/80 transition-transform duration-200 group-hover:scale-110">
                                                <HugeiconsIcon
                                                    strokeWidth={2}
                                                    icon={link.icon}
                ...
                <motion.div
                    ...
                    className="mt-12 border-t border-dash-border/50 pt-8"
                >
