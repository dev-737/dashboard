          ...
          >
            ...
            <div className="relative flex h-20 shrink-0 items-center justify-between px-6">
              ...
              >
                ...
                <span className="bg-linear-to-r from-purple-400 via-indigo-400 to-blue-400 bg-clip-text font-bold text-lg text-transparent tracking-tight transition-all duration-300">
                  InterChat
                </span>
              </Link>
              <Button
