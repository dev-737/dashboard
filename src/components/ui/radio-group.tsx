...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        'aspect-square size-4 shrink-0 rounded-[var(--radius-avatar)] border border-input text-primary shadow-xs outline-none transition-all duration-200 hover:border-ring/50 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:bg-input/30 dark:aria-invalid:ring-destructive/40',
        className
      )}
      {...props}
    >
