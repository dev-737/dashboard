        ...
        >
            ...
            >
                <button
                    type="button"
                    onClick={onToggle}
                    className="flex w-full items-center justify-between rounded-xl p-4 md:p-6 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50"
                >
                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            <div className="border-gray-800/50 border-t px-6 pt-4 pb-4 md:pt-2 md:pb-6 text-gray-400 leading-relaxed">
                                {content}
                            </div>
                        </motion.div>
                    )}
    ...
    return (
        <section className="relative overflow-hidden bg-dash-main py-24 md:py-32">
            ...
            <div className="container relative z-10 mx-auto px-4">
                ...
                >
                    <Button
                        className="rounded-(--radius-button) bg-linear-to-r from-blue-600 to-indigo-600 px-8 py-6 font-semibold text-base text-white shadow-lg transition-all hover:from-blue-700 hover:to-indigo-700"
                        asChild
                    >
                        <Link
