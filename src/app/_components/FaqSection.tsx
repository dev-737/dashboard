    ...
    >
      ...
      >
        <button
          type="button"
          onClick={onToggle}
          className="flex w-full items-center justify-between rounded-xl p-4 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 md:p-6"
        >
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="border-gray-800/50 border-t px-6 pt-4 pb-4 text-gray-400 leading-relaxed md:pt-2 md:pb-6">
                {content}
              </div>
            </motion.div>
          )}
