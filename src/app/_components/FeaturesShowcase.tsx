...
export function FeaturesShowcase() {
    return (
        <section className="relative overflow-hidden bg-dash-main py-24 md:py-32">
            <div className="container relative z-10 mx-auto px-4">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:grid-rows-3">
                    ...
                    <motion.div
                        ...
                        className="group relative overflow-hidden premium-card p-8 md:col-span-2 md:row-span-2"
                    >
                        ...
                        <div className="relative z-10 flex h-full flex-col">
                            ...
                            <div className="mt-auto overflow-hidden rounded-2xl border border-white/10 bg-dash-surface/50 shadow-2xl">
                    ...
                    <motion.div
                        ...
                        className="group relative overflow-hidden premium-card p-8 md:col-span-1 md:row-span-1"
                    >
                    ...
                    <motion.div
                        ...
                        className="group relative overflow-hidden premium-card p-8 md:col-span-2 md:row-span-1"
                    >
                        ...
                        <div className="relative z-10 flex h-full items-center gap-8">
                            ...
                            <div className="relative hidden h-full w-1/3 overflow-hidden rounded-2xl border border-white/10 bg-dash-surface/50 shadow-lg md:block">
                                <Image
