...
export function FeaturesShowcase() {
  return (
    <section className="relative overflow-hidden bg-main py-24 md:py-32">
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:grid-rows-3">
          ...
          <motion.div
            ...
            className="group premium-card relative overflow-hidden p-8 md:col-span-2 md:row-span-2"
          >
          ...
          <motion.div
            ...
            className="group premium-card relative overflow-hidden p-8 md:col-span-1 md:row-span-1"
          >
          ...
          <motion.div
            ...
            className="group premium-card relative overflow-hidden p-8 md:col-span-2 md:row-span-1"
          >
