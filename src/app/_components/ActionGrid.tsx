...
export function ActionGrid() {
  return (
    <section className="relative overflow-hidden bg-main px-4 py-20 md:py-32">
          ...
          {actions.map((action, index) => (
            ...
            >
              <Link href={action.href} className="block h-full">
                <div
                  className={cn(
                    'group premium-card relative h-full overflow-hidden p-8 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl',
                    action.border
                  )}
                >
                  <div
