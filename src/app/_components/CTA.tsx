                ...
                >
                    ...
                    >
                        {[
                            ...
                            <div
                                key={stat.label}
                                className="flex items-center gap-4 premium-card px-6 py-4 transition-all hover:bg-gray-800/50"
                            >
                    ...
                    >
                        ...
                        >
                            <div className="absolute inset-0 rounded-(--radius-button) bg-none" />
                            <Button
                                asChild
                                size="lg"
                                className="relative h-14 rounded-(--radius-button) bg-linear-to-r from-blue-600 to-indigo-600 px-8 font-semibold text-white shadow-lg transition-all hover:shadow-blue-500/25 hover:from-blue-700 hover:to-indigo-700"
                            >
