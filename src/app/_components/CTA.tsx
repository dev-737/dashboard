        ...
        >
          ...
          >
            {[
              ...
              <div
                key={stat.label}
                className="premium-card flex items-center gap-4 px-6 py-4 transition-all hover:bg-gray-800/50"
              >
          ...
          >
            ...
            >
              ...
              <Button
                asChild
                size="lg"
                className="relative h-14 rounded-(--radius-button) bg-linear-to-r from-blue-600 to-indigo-600 px-8 font-semibold text-white shadow-lg transition-all hover:from-blue-700 hover:to-indigo-700 hover:shadow-blue-500/25"
              >
