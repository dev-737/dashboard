...
export default function PremiumPage() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-main pt-32 pb-24">
                ...
                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
                    {tiers.map((tier, index) => (
                        <motion.div
                            ...
                            key={tier.name}
                            className={`group relative flex flex-col overflow-hidden rounded-4xl border bg-[#050810]/60 p-10 backdrop-blur-3xl transition-all duration-500 hover:-translate-y-2 ${tier.popular
                        ...
                        >
                            ...
                            <div className="relative z-10 flex h-full flex-col">
                                <div className="mb-6 flex items-center gap-4">
                                    <div
                                        className={`rounded-2xl bg-[#0A0F1E] p-3.5 shadow-inner ring-1 ${tier.popular
                                ...
                                <div className="mt-auto flex gap-2">
                                    <Button
                                        ...
                                        className={`relative h-14 flex-1 rounded-2xl font-bold transition-all duration-300 ${tier.popular
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        disabled={loadingTier !== null}
                                        onClick={() => handleGiftCheckoutClick(tier.name, tier.id, tier.priceId)}
            ...
            <Dialog open={!!giftTierDialog} onOpenChange={(open) => !open && setGiftTierDialog(null)}>
                <DialogContent className="border-white/10 bg-[#0A0F1E] text-white sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2 text-xl">
                            <HugeiconsIcon icon={GiftIcon} className="h-5 w-5 text-indigo-400" />
                            Purchase Gift Code: {giftTierDialog?.tierName}
                        </DialogTitle>
                        <DialogDescription className="text-gray-400">
                            You are about to purchase a gift code for {giftTierDialog?.tierName}.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                        <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/10 p-4">
                            ...
                            <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-indigo-300">
                                <li>The gift code will be securely generated after successful payment.</li>
                                <li>The code will be displayed to you upon returning to the success page.</li>
                                <li>We'll also send the gift code directly to your DMs within the next 5 minutes.</li>
                            </ul>
                        </div>
                    </div>
