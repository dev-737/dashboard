...
const tiers = [
    {
        ...
        price: '$2.99',
        period: '/month',
        description: 'Premium features for yourself - elevate how you use our service.',
        icon: StarIcon,
...
const comparisonFeatures = [
    ...
    },
    {
        ...
        items: [
            { name: 'Enhanced profile customisation', free: false, core: true, plus: true, pro: true },
            { name: 'Global user badge', free: false, core: true, plus: true, pro: true },
            { name: 'Custom guild profile', free: false, core: false, plus: true, pro: true },
            { name: 'Hub hoisting on website', free: false, core: false, plus: true, pro: true },
            { name: 'Hub badge', free: false, core: false, plus: true, pro: true },
            { name: 'Custom hub badges', free: false, core: false, plus: false, pro: true },
            { name: 'Vanity invites', free: false, core: false, plus: false, pro: true },
            { name: 'Nickname instead of display name', free: false, core: false, plus: true, pro: true },
            { name: 'Preserve special text formatting', free: false, core: false, plus: true, pro: true },
            { name: 'Customisable logs ', free: false, core: false, plus: true, pro: true },
        ],
    },
    {
        category: 'Media & Content Features',
        items: [
            { name: 'External emojis', free: false, core: false, plus: true, pro: true },
            { name: 'Send videos', free: false, core: false, plus: true, pro: true },
            { name: 'Send voice notes', free: false, core: false, plus: true, pro: true },
        ],
    },
    {
        category: 'Control',
        items: [
            { name: 'Priority support', free: false, core: true, plus: true, pro: true },
            { name: 'Hub backups', free: false, core: false, plus: true, pro: true },
            { name: 'Hub analytics & metrics', free: false, core: false, plus: true, pro: true },
        ],
    },
];
...
const faqs = [
    {
        ...
        answer: 'You may cancel your subscription at any time via your profile page. This will end your subscription billing, and your access to premium features will be limited.',
    },
    {
        question: 'How many hubs / guilds can I use my premium on?',
        answer: 'Each plan allows you to use premium features on 1 guild / hub. You may change which guild / hub you use your premium on given this has not been changed in the last seven days.',
    },
    {
        question: 'Can I be refunded?',
        answer: 'We do not offer refunds for premium subscriptions certain conditions have been met - you may request a refund via a ticket. We cannot guarantee a refund will be granted.',
    },
    {
        question: 'How does my premium activate?',
        answer: 'You will automatically be upgraded, and will receive a direct message from the discord bot to confirm. If your DMs are not open, the upgrade process will still proceed, but you will not receive confirmation. Please allow up to five minutes for your upgrade to take effect, and if you have not received a confirmation message, please contact support.',
    }
];
...
export default function PremiumPage() {
    ...
    const handleCheckout = async (tierName: string, tierId: string, priceId: string) => {
        try {
            ...
            <div className="container relative z-10 mx-auto max-w-7xl px-4">
                ...
                >
                    ...
                    <p className="mx-auto max-w-2xl text-gray-400/90 text-lg leading-relaxed md:text-xl">
                        Gain exclusive access to premium features and take your experiance to the next level.
                    </p>
                </motion.div>
                ...
                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-3 md:gap-10">
                    {tiers.map((tier, index) => (
                        ...
                        >
                            {/* Inner Hover Glow */}
                            <div
                                className={`absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100 ${tier.popular
                            ...
                            <div
                                ...
                                style={{ background: tier.popular ? premiumGradient : undefined }}
                            />
                            ...
                            <div className="relative z-10 flex h-full flex-col">
                                <div className="mb-6 flex items-center gap-4">
                                    ...
                                    <h2 className="font-bold text-2xl text-white tracking-tight">{tier.name}</h2>
                                </div>
                    ...
                    <div className="overflow-x-auto rounded-4xl border border-white/5 bg-[#050810]/40 p-8 backdrop-blur-2xl">
                        <div className="min-w-200">
                            ...
                            <div className="grid grid-cols-5 gap-4 border-white/10 border-b pb-6">
                                ...
                                <div className="col-span-1 text-center font-bold text-[#7B61FF]">Plus</div>
                                <div className="col-span-1 text-center font-bold text-[#D55CFF]">Pro</div>
                            </div>
                                    ...
                                    <div className="space-y-2">
                                        {section.items.map((item, itemIdx) => (
                                            ...
                                            >
                                                ...
                                                {/* Cells mapping logic */}
                                                {[item.free, item.core, item.plus, item.pro].map((val, colIdx) => (
                                                    <div key={colIdx} className="col-span-1 flex justify-center text-center">
                                                        {typeof val === 'boolean' ? (
                                                            val ? (
                                                                <HugeiconsIcon
                                                                    icon={CheckmarkSquare01Icon}
                                                            ...
                                                            <span className={`font-semibold ${colIdx === 0 ? 'text-gray-400' : 'text-gray-200'}`}>
                                                                {val}
                                                            </span>
                                                        )}
                                                    </div>
