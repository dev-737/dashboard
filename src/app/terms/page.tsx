              ...
              <div className="prose prose-lg prose-invert prose-li:my-2 max-w-none prose-ol:list-decimal prose-ul:list-disc prose-ol:pl-6 prose-ul:pl-6 prose-headings:text-white prose-li:text-gray-300 prose-p:text-gray-300 prose-strong:text-purple-300">
                <div className="space-y-16">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <ul className="space-y-3">
                        ...
                        <li className="transition-colors hover:text-purple-200">
                          ...
                          — messages, files, images, links, or other material
                          you submit, post, or transmit through the Service.
                        </li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        You agree to use the Service lawfully and in compliance
                        with Discord's Terms of Service and our Community
                        Guidelines.
                      </p>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        ...
                        content you grant InterChat a worldwide, royalty-free,
                        sublicensable, transferable license to host, use,
                        reproduce, modify, publish, and distribute that content
                        solely to provide and improve the Service.
                      </p>
                      <p>
                        You warrant that you have the rights to submit your
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        We operate automated and manual moderation. We may
                        remove content, mute users, suspend accounts, or ban
                        users for violations.
                      </p>
                      <p>
                        <strong className="text-purple-300">
                          Evidence and logs:
                        </strong>{' '}
                        We keep logs and message snapshots for moderation and
                      ...
                      <p className="rounded-xl border border-green-500/30 bg-linear-to-r from-green-400/20 to-emerald-400/20 p-4 text-green-200">
                        ...
                        with your Discord ID, incident details, and supporting
                        evidence. Appeals are reviewed. Submitting an appeal
                        does not guarantee reversal. Abuse of the appeals
                        process may result in permanent enforcement.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        We apply rate limits and quotas. Excessive or abusive
                        use can be throttled, limited, or terminated. You will
                        be notified when practical.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        The Service uses third-party providers (e.g., Discord,
                        hosting, analytics). Those providers may have separate
                        terms and privacy practices. You agree we may share data
                        required to operate the Service. See our Privacy Policy.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p className="rounded-xl border border-emerald-500/30 bg-linear-to-r from-emerald-400/20 to-green-400/20 p-4 text-emerald-200">
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        InterChat and its content, trademarks, logos, and
                        software are our property or licensed to us. You may not
                        copy, modify, publish, distribute, or create derivative
                        works without our written permission.
                      </p>
                      <p>
                        If you provide feedback or suggestions, you grant us an
                        irrevocable, perpetual, worldwide, royalty-free license
                        to use that feedback for any purpose.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        We may suspend or terminate your access at our
                        discretion for breach of these Terms or for any lawful
                        reason. On termination, your rights under these Terms
                        end immediately. We may preserve necessary records and
                        data per our retention policies and legal obligations.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        ...
                        purpose, and non-infringement. We do not guarantee
                        uptime, availability, or that the Service is free of
                        defects.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        To the fullest extent permitted by law, InterChat and
                        its officers, employees, agents, and partners will not
                      ...
                      <p className="rounded-xl border border-amber-500/30 bg-linear-to-r from-amber-400/20 to-yellow-400/20 p-4 text-amber-200">
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        You agree to indemnify and hold InterChat harmless from
                        any claims, liabilities, losses, damages, and expenses
                        (including reasonable attorneys' fees) arising from your
                        use of the Service, your User Content, or your breach of
                        these Terms.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        We may change these Terms. For material changes, we will
                        provide notice via the website or our Discord server
                        before they take effect. Continued use after notice
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        ...
                        with a DMCA takedown notice including identification of
                        the copyrighted work, location of infringing material,
                        contact information, a statement of good faith, and a
                        signature.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="group">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        For questions, enforcement appeals, legal notices, or
