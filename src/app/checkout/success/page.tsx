...
import { ArrowLeft01Icon, Tick01Icon, Copy01Icon } from '@hugeicons/core-free-icons';
            ...
            >
                {giftCode ? (
                    ...
                    <>
                        ...
                        You should see the changes reflected in your account shortly.
                    </>
                )}
            </motion.p>
            ...
            {giftCode && (
                ...
                >
                    <div className="inline-block rounded-2xl border border-indigo-500/20 bg-indigo-500/10 p-6 shadow-[0_0_30px_rgba(99,102,241,0.1)]">
                        <h3 className="mb-3 font-semibold text-indigo-400 text-sm uppercase tracking-wider">Your Gift Code</h3>
                        <div className="flex items-center gap-3">
                            <code className="rounded border border-white/10 bg-black/40 px-4 py-2 font-mono text-xl text-white">
                                {giftCode}
                            </code>
                            <Button
                                variant="outline"
                        ...
                        <p className="mt-3 text-indigo-300/60 text-xs">
                            Direct link: {typeof window !== 'undefined' ? `${window.location.origin}/gift/${giftCode}` : `/gift/${giftCode}`}
                        </p>
                    </div>
                </motion.div>
            )}
