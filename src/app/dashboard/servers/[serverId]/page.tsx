      ...
      <div className="space-y-6">
        <Card className="border border-gray-800/50 bg-dash-main backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <Button
              asChild
              className="border-none bg-linear-to-br from-[#6352BE] to-[#463988] hover:from-[#6352BE]/40 hover:to-[#6352BE]/40"
            >
              <Link href="/dashboard">Back to Servers</Link>
            </Button>
          </CardContent>
                ...
                {botAdded ? (
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <Button
                        asChild
                        className="w-full border-none bg-linear-to-br from-[#6352BE] to-[#463988] hover:from-[#6352BE]/40 hover:to-[#6352BE]/40"
                      >
                        <Link
              ...
              {!botAdded ? (
                ...
                <div className="py-10 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Server settings configuration will be available soon.
                  </p>
                </div>
              )}
            </CardContent>
